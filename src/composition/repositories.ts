...
import type { ReviewRepository } from "@/application/repositories/review-repository";
...
import { reviewRepository as reviewRepo } from "@/infrastructure/persistence/file-review-repository";
...
export const reviewRepository: ReviewRepository = reviewRepo;
