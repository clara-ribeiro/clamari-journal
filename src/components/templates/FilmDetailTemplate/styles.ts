...
export const ViewingMeta = styled("p", {
  margin: 0,
  fontSize: "$body2",
  color: "$catalogMutedOnDark",
});

export const ViewingList = styled("ol", {
  listStyle: "none",
  margin: 0,
  padding: 0,
  display: "flex",
...
export const ViewingItem = styled("li", {
  display: "flex",
  justifyContent: "space-between",
  gap: "$md",
  alignItems: "baseline",
  padding: "$sm 0",
  borderBottom: "1px solid $catalogBorderOnDark",
  fontSize: "$body1",
  color: "$catalogTextOnDark",
});

export const ViewingKind = styled("span", {
  fontSize: "$body2",
  letterSpacing: "0.04em",
  textTransform: "uppercase",
  color: "$catalogMutedOnDark",
