...
export const {
  ...
  theme: {
    colors: {
      ...
      catalogBg: "#F1DFC2",
      catalogBgFilms: "#2A221C",
      catalogBgPaper: "#F8F0DE",
      catalogText: "#1A1410",
      catalogTextOnDark: "#F1DFC2",
      catalogMuted: "rgba(26, 20, 16, 0.62)",
      catalogMutedOnDark: "rgba(241, 223, 194, 0.62)",
      catalogBorder: "rgba(26, 20, 16, 0.14)",
      catalogBorderOnDark: "rgba(241, 223, 194, 0.14)",
    },
    fonts: {
      ...
      bivaque: "var(--font-bivaque), Impact, Haettenschweiler, sans-serif",
